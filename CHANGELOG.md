...
- Removed "status" from `AnimalCard` component since it was not part of released design
...
- [#2](https://github.com/devias-io/react-material-dashboard/pull/2) Fixed `AnimalCard` component description height
